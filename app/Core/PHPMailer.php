...
use App\Core\SMTP;
use App\Core\Exceptions\PhpMailerException;
...
class PHPMailer
{
            ...
            foreach ($images[2] as $imgindex => $url) {
                ...
                if (preg_match('#^data:(image[^;,]*)(;base64)?,#', $url, $match)) {
                    ...
                    if ($this->addEmbeddedImage(
                        ...
                        $filename,
                        'base64',
                        self::mimeTypes((string)self::mbPathInfo($filename, PATHINFO_EXTENSION))
                    )
                    ) {
    ...
    public static function filenameToType($filename)
    {
        ...
        $pathinfo = self::mbPathInfo($filename);
        return self::mimeTypes($pathinfo['extension']);
    }
    ...
    public function dkimAdd($headers_line, $subject, $body)
    {
        ...
        $date = str_replace('|', '=7C', $this->dkimQP($date_header));
        $subject = str_replace(
            '|',
            '=7C',
            $this->dkimQP($subject_header)
